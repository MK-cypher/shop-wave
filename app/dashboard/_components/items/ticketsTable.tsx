          ...
          <Dialog>
            <DropdownMenu>
              ...
              >
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem>
                  <DialogTrigger>Ticket Details</DialogTrigger>
                </DropdownMenuItem>
                {/* <DropdownMenuItem>
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-4">
        <SearchFilter link="dashboard/tickets/" searchParams={searchParams} />
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        ...
        <div className="space-x-2">
          <FilterPage searchParams={searchParams} total={total} category="dashboard/tickets" link="dashboard/tickets" />
        </div>
      </div>
    </div>
  );
