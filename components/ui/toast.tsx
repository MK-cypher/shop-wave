...
>(({className, ...props}, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[301] flex max-h-screen w-full flex-col-reverse p-4 sm:top-0 sm:right-0 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
...
>(({className, ...props}, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-1 top-1 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-1 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.success]:text-emerald-300 group-[.destructive]:hover:text-red-50 group-[.success]:hover:text-emerald-50 group-[.destructive]:focus:ring-red-400 group-[.success]:focus:ring-emerald-400 group-[.destructive]:focus:ring-offset-red-600 group-[.success]:focus:ring-offset-emerald-600",
      className
    )}
    toast-close=""
    {...props}
